...
df = pd.read_csv("D:/IBM Bob/Capstone Project/Case Study_Interactive Charts - Order Data.csv")
...
rules_clean.to_csv("D:/IBM Bob/Capstone Project/outputs/rules.csv", index=False)
...
orders_clean.to_csv("D:/IBM Bob/Capstone Project/outputs/orders.csv", index=False)
